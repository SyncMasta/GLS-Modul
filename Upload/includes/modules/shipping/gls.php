...
/* -----------------------------------------------------------------------------------------
   ...
   (c) 2002-2003 osCommerce(gls.php,v 1.40 2003/02/05); www.oscommerce.com 
   (c) 2003	 nextcommerce (gls.php,v 1.7 2003/08/24); www.nextcommerce.org
  ...
  class GLS_ORIGIN {
    ...
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            ...
                            'methods' => array(array('id' => $this->code,
                                                     'title' => MODULE_SHIPPING_GLS_TEXT_WAY,
                                                     'cost' => MODULE_SHIPPING_GLS_COST)));
    ...
    function install() {
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, date_added) values ('MODULE_SHIPPING_GLS_STATUS', 'True', '6', '0', 'gm_cfg_select_option(array(\'True\', \'False\'), ', now())");
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) values ('MODULE_SHIPPING_GLS_COST', '0.00', '6', '0', now())");
    ...
    function keys() {
      return array('MODULE_SHIPPING_GLS_STATUS', 'MODULE_SHIPPING_GLS_COST','MODULE_SHIPPING_GLS_ALLOWED', 'MODULE_SHIPPING_GLS_TAX_CLASS', 'MODULE_SHIPPING_GLS_ZONE', 'MODULE_SHIPPING_GLS_SORT_ORDER');
    }
  }
  
MainFactory::load_origin_class('gls');
?>